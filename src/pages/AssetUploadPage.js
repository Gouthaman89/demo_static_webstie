...
const { globalOrgId, personId } = useGlobalContext();
 ...
 const fetchAssets = async (orgId) => {
  ...
  if (/\.csv$/i.test(file.name)) {
      ...
      reader.onload = (e) => {
        ...
        setAssetData(Array.isArray(jsonData) ? jsonData : []);
  ...
  return (
    <>
      {loading ? (
        ...
        <Container disableGutters maxWidth={false} style={{ marginTop: 24 }}>
          <Box style={{ maxWidth: '1700px', margin: '0 auto' }}>
            ...
            {filteredAssets.length > 0 && (
              <Card>
                <CardContent style={{ flex: 4, display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
                            ...
                            <TableRow key={asset.uuid}>
                              ...
                              >
                                <Box style={{ display: 'flex', gap: 8, justifyContent: 'center' }}>
                                  ...
                                  <IconButton onClick={() => handleDeleteAsset(asset)} style={{ color: '#d32f2f' }}>
                                    <DeleteIcon />
                                  </IconButton> 
                                  <IconButton onClick={() => handleViewImages(asset)} style={{ color: '#1976d2' }}>
                                    <ImageIcon />
                                  </IconButton>
      ...
      >
        ...
        <DialogContent>
          <Box className="scrollable-table-container" style={{ maxHeight: '70vh' }}>
            <TableContainer component={Paper}>
              <Table style={{ minWidth: 800 }} aria-label="service factor table">
                <TableHead>
                  <TableRow>
                    {assetData.length > 0 &&
        ...
        <DialogTitle>
          <Box style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8 }}>
            ...
            <Button
              ...
              style={{ color: isDeleteMode ? undefined : '#d32f2f', borderColor: isDeleteMode ? undefined : '#d32f2f' }}
            >
        ...
        <DialogContent>
          {imagesLoading ? (
            ...
            <Box>
                  ...
                  {isDeleteMode && (
                    ...
                    >
                      <IconButton
                        ...
                        style={{ pointerEvents: 'auto', backgroundColor: 'rgba(255,255,255,0.8)' }}
                      >
                        <DeleteIcon style={{ fontSize: 64, color: '#d32f2f' }} />
                      </IconButton>
                    </Box>
                  )}
                </Box>
              ...
              <Box style={{ display: 'flex', gap: 8, overflowX: 'auto' }}>
                {images.map((img, idx) => (
                  <Box key={idx} style={{ position: 'relative', width: '80px', height: '80px' }}>
                    <Box
                      style={{
                        width: '100%',
                        height: '100%',
                    ...
                    {isDeleteMode && (
                      ...
                      >
                        ...
                        >
                          <DeleteIcon style={{ fontSize: 32, color: '#d32f2f' }} />
                        </IconButton>
                      </Box>
                    )}
                  </Box>
            ...
            <Box style={{ textAlign: 'center', paddingTop: 32, paddingBottom: 32 }}>
